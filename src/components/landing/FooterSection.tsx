...
export default function FooterSection() {
  return (
    <footer role="contentinfo" aria-label="Site footer" className="border-t border-border py-16">
      <div className="container px-4">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-xs">
              AI-powered revenue operations that help your team close more deals, faster.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Leep AI. All rights reserved.
          </p>
