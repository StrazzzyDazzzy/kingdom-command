...
export const payoutTracker2025: PayoutEntry[] = [
  ...
  { id: 'p25-13', name: 'Paycom Income 2025', investments: 0, expectedAnnualPayout: 0, yearIncome: 332000, initiationDate: '', firstPayoutDate: '', investmentEndDate: '', expectedMonthlyPayout: 0, monthlyMortgage: 0, noiMonthly: 0, interestRate: '', notes: '', remainingOnLoan: '', payoutVariance: 0, payoutCompletion: 0, year: 2025 },
  { id: 'p25-14', name: 'Tax Refunds', investments: 120000, expectedAnnualPayout: 0, yearIncome: 0, initiationDate: '', firstPayoutDate: '', investmentEndDate: '', expectedMonthlyPayout: 0, monthlyMortgage: 0, noiMonthly: 0, interestRate: '', notes: '', remainingOnLoan: '', payoutVariance: 0, payoutCompletion: 0, year: 2025 },
];
...
export const payoutTracker2026: PayoutEntry[] = [
  ...
  { id: 'p26-11', name: 'Tax Refund - Movie Play', investments: 0, expectedAnnualPayout: 0, yearIncome: 25000, initiationDate: '', firstPayoutDate: '', investmentEndDate: '', expectedMonthlyPayout: 0, monthlyMortgage: 0, noiMonthly: 0, interestRate: '', notes: '', remainingOnLoan: '', payoutVariance: 0, payoutCompletion: 0, year: 2026 },
  { id: 'p26-12', name: 'Tax Refund - Fee Simple', investments: 0, expectedAnnualPayout: 0, yearIncome: 58000, initiationDate: '', firstPayoutDate: '', investmentEndDate: '', expectedMonthlyPayout: 0, monthlyMortgage: 0, noiMonthly: 0, interestRate: '', notes: '', remainingOnLoan: '', payoutVariance: 0, payoutCompletion: 0, year: 2026 },
];
